import "./createGroupPostModal.css"
...
const CreateGroupPostModal: React.FC<CreateGroupPostModalProps> = ({ group, user, activeUsers, isOpen, onClose }) => {
    ...
    return (
        <div className="createPostModalOverlay" style={{ display: isOpen ? "flex" : "none" }}>
            <div className="createPostModalContent">
                <span className="createPostModalTxt">Create Group Post</span>
                <div className="createPostModalTop">
                    <div className="createPostModalTopLeft">
                        ...
                        <div className="createPostModalTopLeftRight">
                            <span className="createPostModalUserName">{group?.name} - {user?.firstname} {user?.lastname}</span>
